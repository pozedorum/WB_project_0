...
// Order - основная структура заказа, название таблицы orders
type Order struct {
...
// Delivery - информация о доставке, название таблицы deliveries
...
// Payment - информация об оплате , название таблицы payments
type Payment struct {
...
// Item - информация о товаре, название таблицы items
type Item struct {
